...
extern XSIEXPORT CEnumDictionary<CSLTemplate::EFCurveType, CSLTemplate::SI_NODEVIS> g_FCurveTypeDictionary;

XSIEXPORT	CEnumDictionary<CSLTemplate::EFCurveType, CSLTemplate::SI_NODEVIS>* GetFCurveEnumDictionary();
...
{
public:
	typedef CSLStrEnumProxy<EFCurveType, SI_NODEVIS> EFCurveTypeProxy;
