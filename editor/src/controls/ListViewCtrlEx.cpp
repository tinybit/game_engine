...
//void CListCtrlEx::CancelItemEditing()
//{
...
//		*pResult = 1;
//		
//	//GetParent()->SendNotifyMessage( LVN_ENDLABELEDIT, IDC_LST_OBJECT, (LPARAM)plvDispInfo );
//}
...
void CListCtrlEx::OnKillFocus( CWnd* pWnd ) 
{
	//if( !m_bEdited )
	//	return;
...
void CListCtrlEx::OnLButtonDown( UINT nFlags, CPoint point ) 
{
	...
	////if (over a subitem)
	//if( GetSelectedCount() == 1 && item != -1 && lvhit.iSubItem && ( lvhit.flags & LVHT_ONITEM ) )
 //   {
	//	if( GetItemState( lvhit.iItem, LVIS_SELECTED ) != LVIS_SELECTED || m_bEdited )
	//	{
	//		CListBase::OnLButtonDown( point );
	//		return;
	//	}

	//	//mouse click outside the editbox in an already editing cell cancels editing
...
void CListCtrlEx::OnSetFocus( CWnd* pWnd ) 
{
	CListCtrl::OnSetFocus( pWnd );
}
...
//void CListBase::OnBeginLabelEdit( NMHDR* pNMHDR, LRESULT* pResult )
//{ 
//	m_pListCtrl->Default(); 
//}
