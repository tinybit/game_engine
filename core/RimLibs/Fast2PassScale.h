...
class CFast2PassScale 
{
	public:
		...
		DWORD* AllocAndScale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, int uNewWidth, int uNewHeight );
		DWORD* Scale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, DWORD* pDstImage, int uNewWidth, int uNewHeight);
		DWORD* TransparentScale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, DWORD* pDstImage, int uNewWidth, int uNewHeight, DWORD TransparentColor );
	...
	private:
		...
		void				SuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight );
		void				TransparentSuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight, DWORD TransparentColor );
		void				SSESuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight );
		void				SSETransparentSuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight, DWORD TransparentColor );
};
