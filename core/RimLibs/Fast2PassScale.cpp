...
{ 
    ...
    {   // Scan through line of contributions
        ...
        //if( dTotalWeight >= 0.0 )   // An error in the filter function can cause this
		//	return NULL;
...
void CFast2PassScale::SuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight )
{
...
void CFast2PassScale::TransparentSuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight, DWORD TransparentColor )
{
    LineContribType * YContrib = CalcContributions (uResHeight, uSrcHeight, float(uResHeight) / float(uSrcHeight)); 
    LineContribType * XContrib = CalcContributions (uResWidth, uSrcWidth, float(uResWidth) / float(uSrcWidth)); 
...
void CFast2PassScale::SSESuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight )
{
...
void CFast2PassScale::SSETransparentSuperScale( DWORD* pSrc, int uSrcWidth, int uSrcHeight, DWORD* pDst, int uResWidth, int uResHeight, DWORD TransparentColor )
{
...
DWORD* CFast2PassScale::AllocAndScale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, int uNewWidth, int uNewHeight )
{ 
...
DWORD* CFast2PassScale::Scale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, DWORD* pDstImage, int uNewWidth, int uNewHeight )
{ 
...
DWORD* CFast2PassScale::TransparentScale( DWORD* pOrigImage, int uOrigWidth, int uOrigHeight, DWORD* pDstImage, int uNewWidth, int uNewHeight, DWORD TransparentColor )
{ 
